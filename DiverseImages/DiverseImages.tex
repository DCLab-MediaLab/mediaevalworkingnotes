...
Figure \ref{fig:p}. shows the values of P@N and CR@N for the different runs, while table \ref{table:results}. shows the average P@20, CR@20 and F1@20 results.

The results of the five approaches mainly differ in P@N performance. The diversity is almost the same, so P@N has more impact on the $F_1$ score.
...
The credibility information tends to have negative effect on both P@N and CR@N in our tests.
